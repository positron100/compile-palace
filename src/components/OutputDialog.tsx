...
const OutputDialog: React.FC<OutputDialogProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="max-w-4xl p-0 overflow-hidden border-none rounded-xl shadow-2xl"
      ...
      >
        ...
        <div className="p-0 overflow-auto max-h-[70vh] bg-gradient-to-b from-slate-50 to-white rounded-b-xl">
          <OutputSection outputDetails={outputDetails} />
          
          {outputDetails && (
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200 flex items-center justify-between text-xs text-slate-500 rounded-b-xl">
